...
import { TEMPLATE_NAMES } from "../services/whatsapp/template-registry.js";

export const whatsappTemplatesRouter: ExpressRouter = Router();

// GET /api/internal/whatsapp/templates
// Returns the list of template names used by the system (templates are created via Postman / Meta admin).
